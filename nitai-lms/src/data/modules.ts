...
// NOTE: Videos are uploaded to Google Drive and linked via shareable URLs.
// Update videoUrl with the Google Drive share link (e.g., https://drive.google.com/file/d/FILE_ID/view?usp=share_link)
...
export const modules: Module[] = [
  ...phase1Titles.map((title, i) => ({
    ...
    videoUrl:
      i === 0
        ? 'https://drive.google.com/file/d/1zMPXdiptDF6oiM-NlJ4rmmbVUMS40s_-/view?usp=share_link'
        : i === 1
        ? 'https://drive.google.com/file/d/1t_hrdKRtTQXiTlSNAix51QDcJtvvHU3R/view?usp=share_link'
        : undefined,
  })),
